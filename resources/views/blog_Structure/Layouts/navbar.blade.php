...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{ asset('blogStyle') }}/assets/favicon.ico" />
    ...
    <link href="{{ asset('blogStyle') }}/css/styles.css" rel="stylesheet" />
</head>
<body>
    <!-- Navigation-->
        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto py-4 py-lg-0">
                    ...
                    @include('blog_Structure.Layouts.navItemWidget')
